...
titles = ['Software Engineer', 'Product Manager', 'Data Analyst', 'HR Specialist', 'Sales Representative']
statuses = ['active', 'inactive']

# Create CSV
with open('employees.csv', 'w', newline='') as csvfile:
    fieldnames = ['employeeNumber', 'username', 'givenName', 'familyName', 'displayName', 'mail', 'status', 'title', 'country', 'department', 'region']
